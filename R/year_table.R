#' Tableau interactif avec filtre par année.
#'
#' Cette fonction crée un tableau interactif avec un filtre par année à partir du dataframe
...
#' @param year_input L'année(s) à filtrer dans lZe tableau.
#' @importFrom dplyr filter select
#' @import gt
#' @export
year_table <- function(df_prices, year_input){
  return(
    df_prices |>
